...
program
  ...
  .option('-m, --multi', 'multiple protobuf messages with prefixed signed 32-bit big endian message length')
  .parse(process.argv);
...
protobuf2json(false, program.directory, program.proto, program.type, program.multi);
